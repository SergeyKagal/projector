export const ru = {
  ...
  jobs: [
    ...
    `Авторизация. Drag'n'drop. Профиль пользователя. Прелоадер.`,
    'Страницы: приветствие и борд. Доп. функционал. Стили, адаптив. ',
  ],
  ...
  deleteBoard: {
    title: 'Подтверждение удаления',
    description: 'Вы уверены, что хотите удалить борд',
  },
  redirectionPopup: {
